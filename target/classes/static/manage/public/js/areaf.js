...
function change(v,index){
	...
	with(ss){
		...
		if(++v<o.length){change(v,index);}
	}//End with
}

var s=["f_province","f_city","f_county"];//三个select的name
var s1=["s_province","s_city","s_county"];//三个select的name
var opt0 = ["省份","地级市","区/县"];//初始值

function _init_area(fn){ //初始化函数
//	try{
...
//	}
	for(i=0;i<s1.length-1;i++){
		document.getElementById(s1[i]).onchange=new Function("change("+(i+1)+",1)");
	}
