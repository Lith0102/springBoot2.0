...
<px:Content contentPlaceHolderId="content">
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header layui-bg-blue">
			<div class="layui-logo" style="color: #fff">后台管理系统</div>
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item">
					<a href="javascript:;"> 
						<img src="/static/manage/images/index/u1052.png" class="layui-nav-img">${username }
						<input type="hidden" id="user_id" value="${sessionScope.userId}" name="user_id">
					</a>
