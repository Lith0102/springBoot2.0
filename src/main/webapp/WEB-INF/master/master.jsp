...
<link rel="stylesheet" href="/static/manage/public/layui/css/layui.css" />
<link rel="stylesheet" href="/static/manage/public/js/themes/default/css/ueditor.css" />
	<style type="text/css">
		.leftMain .layui-icon {
			margin-right: 5px;
		}
...
<body style="overflow-y:auto" class="layui-layout-body">
	...
	<script type="text/javascript" src="/static/manage/public/js/jquery-1.11.3.js"></script>
	<script type="text/javascript" src="/static/manage/public/layui/layui.js"></script>
	<script type="text/javascript" src="/static/manage/public/layui/mui_use.js"></script>
	<script type="text/javascript" charset="utf-8" src="/static/manage/public/js/ueditor.config.js"></script>
	<script type="text/javascript" charset="utf-8" src="/static/manage/public/js/ueditor.all.js"> </script>
	<script type="text/javascript" charset="utf-8" src="/static/manage/public/js/lang/zh-cn/zh-cn.js"></script>
	<script type="text/javascript">
		...
		$(function(){
			$("img").error(function() {
				$(this).attr("src", "/static/manage/images/index/noImage.jpg");
			});
