...
<m:Content contentPlaceHolderId="css">
	<link rel="stylesheet" href="/static/manage/public/css/layui_public/layui_dyx.css"/>
	<style type="text/css">
		body{
			height: 100%;
		}
...
<m:Content contentPlaceHolderId="content">
	...
	<div style="padding: 15px;" class="layui-anim layui-anim-upbit">
		...
		<form action="/${applicationScope.adminprefix }/system/paymethod/batchImport" enctype="multipart/form-data" id="excelForm" method="post" style="display: none;">
		...
		<div class="layui-form-item" style="padding-top: 10px; margin-bottom: 0;">
			...
			<div class="layui-inline">
				<button class="layui-btn testdown"><i class="layui-icon">&#xe654;</i>导出</button>
			</div>
			<div class="layui-inline">
				<button class="layui-btn daoru"><i class="layui-icon">&#xe654;</i>导入</button>
			</div>
			<%--测试--%>
			<div class="layui-inline">
				<button class="layui-btn test1"><i class="layui-icon">&#xe654;</i>库1</button>
			</div>
			<div class="layui-inline">
				<button class="layui-btn test2"><i class="layui-icon">&#xe654;</i>库2</button>
			</div>
...
<m:Content contentPlaceHolderId="js">
	<script type="text/javascript" src="/static/manage/public/js/ToolTip.js"></script>
	<script src="/static/manage/public/js/jquery.form.min.js"></script>
	<script type="text/javascript">
		...
		layui.use(['laypage', 'layer', 'table', 'form'], function(){
			...
			$(".test1").click(function () {
				window.location.href="/${applicationScope.adminprefix }/test/aaa"
            })
            $(".test2").click(function () {
                window.location.href="/${applicationScope.adminprefix }/test/bbb"
            })
			//导入
        ...
        function submitExcel(){
            $("#excelForm").ajaxSubmit({
                url:"/${applicationScope.adminprefix }/system/paymethod/batchImport",
                type : "post",
