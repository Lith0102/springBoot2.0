package com.lth.system.service;
...
public class UserService {
	...
	public int addAdminUserInfo(Map<String, Object>  userMap){
		...
		//添加用户表
		int row = sqlSession.insert("userDao.addAdminUserInfo",userMap);
		if(row >0){
			//添加用户角色关联表
	 ...
	 * @return
	 */
	public Object selUserRole(String userId) {
		return sqlSession.selectList("userDao.selUserRole", userId);
	}
